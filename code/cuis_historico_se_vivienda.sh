...
####################################
# CUIS Historico: Socioeconomicos de viviendas
####################################

# Este script descarga los datos socioeconomicos de viviendas del CUIS Historico (Cuestionario Unico de Informacion Socioeconomica)
...
echo "Downloading Socioeconomicos: viviendas data. 
