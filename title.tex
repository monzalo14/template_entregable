...
\newcommand{\DelTitle}{Resultados, conclusiones y recomendaciones}
\newcommand{\DelNumber}{3}
...
\newcommand\Bstrut{\rule[-0.9ex]{0pt}{0pt}}   % = `bottom' strut
  ...
  \begin{tabular}{|l|p{115mm}|}\hline
    ...
    \Tstrut\Bstrut Fecha de Entrega Contractual:& Diciembre - 2018\\\hline
    \Tstrut\Bstrut Fecha de Entrega:& Enero 2019\\\hline
    ...
    \Tstrut\Bstrut Keywords:& estimación ingreso ciencia datos modelos gráficos \\\hline
    \Tstrut Autor:&
    \begin{tabular}[t]{l}
